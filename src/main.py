...
CORS(app, supports_credentials=True, origins=["https://rpg-frontend-flame.vercel.app"], allow_headers=["Content-Type", "Authorization"], methods=["GET", "POST", "PUT", "DELETE", "OPTIONS"])
